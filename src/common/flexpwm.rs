...
//!
//! let gpio_b0_10 = // Handle to the pad, channel A
//!     # unsafe { imxrt_iomuxc::imxrt1060::gpio_b0::GPIO_B0_10::new() };
//! let gpio_b0_11 = // Handle to the pad, channel B
//!     # unsafe { imxrt_iomuxc::imxrt1060::gpio_b0::GPIO_B0_11::new() };
//! pwm.prepare_pin(gpio_b0_10).unwrap();
//! pwm.prepare_pin(gpio_b0_11).unwrap();
//!
